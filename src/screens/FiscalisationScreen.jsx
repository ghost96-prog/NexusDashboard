...
import "../Css/FiscalisationScreen.css";
...
const FiscalisationScreen = () => {
  ...
  const handleClickOutside = (event) => {
    if (
      isStoreDropdownOpen &&
      !event.target.closest(".buttonContainerStores")
    ) {
    ...
    if (
      ...
      !event.target.closest(".buttonContainerExport")
    ) {
    ...
    <div className="mainContainerReceipts">
      ...
      <div className="toolBar">
        <div className="toolBarLeft">
          <img
            src="/src/assets/adaptive1.png"
            alt="Logo"
            className="logoImage"
          />
          <span className="toolBarTitle">
            Nexus Virtual Fiscalisation Device
          </span>
        </div>
        <div className="toolBarRight">
          <span className="userEmail">{email}</span>
          <div className="userIconWrapper" onClick={handleToggleDropdown}>
            <FaUserCircle className="userIcon" />
            <div className="userTooltip">{email}</div>
          </div>
        </div>
      </div>

      <div className="buttonsContainerFiscal">
        <div className="buttonContainerDateFiscal">
        ...
        <div className="buttonContainerStores">
          <button
        ...
        <div className="buttonContainerExport">
          <button
            className="inputButtonExport"
            onClick={() => {
      ...
      <div className="receiptsContainerFiscal">
        {/* Search Input */}
...
export default FiscalisationScreen;
